...
class Settings(BaseSettings):
    ...
    EVOLUTION_API_URL: str = "http://localhost:8080"  # Em Docker: http://evolution-api:8080
    ...
    # CORS
    ALLOWED_ORIGINS: str = "http://localhost:3000,http://localhost:5173"  # CSV de origens permitidas
